package com.luizalabs.legacyorderapi.utils;

import java.time.LocalDate;
import java.util.UUID;

public class Constants {
    public static final String UPLOAD_MESSAGE_SUCCESS = "Arquivo carregado com sucesso.";
    public static final String UPLOAD_MESSAGE_FAILURE = "Erro ao processar o arquivo.";
    public static final UUID UUID_A = UUID.randomUUID();
    public static final int USER_ID_A = 1;
    public static final String USER_NAME_A = "Fulado de Tal";
